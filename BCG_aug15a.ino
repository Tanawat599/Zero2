...
const int LOADCELL_SCK_PIN1 = 19;
*/
HX711 scaleIron;
HX711 scalePlastic;
...
String RfidData[3] = {"54:EB:63:24","D2:F7:4A:2E","E1:46:E1:1B"};
...
void Separate() {
  ...
  if (Proxy == 0) {
    float randomFloat = 12.0 + (random(0, 10001) / 10000.0) * (18.0 - 12.0);
    Iron += Iron;
    ironWeight = ironWeight + randomFloat;
